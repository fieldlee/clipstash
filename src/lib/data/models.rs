...
impl From<crate::services::ask::GetClip> for GetClip {
    fn from(shortcode: crate::services::ask::GetClip) -> Self {
        GetClip {
            shortcode: shortcode.shortcode.into_inner(),
        }
    }
}
...
impl From<crate::services::ask::NewClip> for NewClip {
    fn from(req: crate::services::ask::NewClip) -> Self {
        Self { 
...
impl From<crate::services::ask::UpdateClip> for UpdateClip {
    fn from(req: crate::services::ask::UpdateClip) -> Self {
        Self { 
            content: req.content.into_inner(),
            title: req.title.into_inner(),
            expires: req.expires.into_inner().map(|time| time.timestamp()),
